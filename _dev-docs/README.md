...
This folder preserves the derivation notes for Axiomatic Sovereignty.

These files are not the public entry path. They are provenance for people who want to understand how the repository frame was derived, debated, and refined.
...
Use `_dev-docs/` to recover intent, trace terminology, and compare future changes against the founding conversation.

Do not treat `_dev-docs/` as the canonical public specification. The root documents and five layer directories are the public interface of the repository.
...
Older notes may reference superseded root files or terminology. Preserve them as provenance, but use the root documents for the public presentation.
