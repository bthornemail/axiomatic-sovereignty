# =========================================================================
# AXIOMATIC SOVEREIGNTY: STANDALONE LOCAL VALIDATION HARNESS
# =========================================================================
...
verify:
	@echo "--- RUNNING STANDALONE LAYER 5 SESSION AUDIT ---"
	ghc -fno-code .omi/SovereigntyModel.hs
	runghc -i.omi .omi/SovereigntyModelCheck.hs
	cc -std=c99 -Wall -Wextra -pedantic -fsyntax-only .omi/sovereignty_session_check.c
	...
	@echo "--- STANDALONE VERIFICATION PASSED: SESSION IMMUTABLE ---"
